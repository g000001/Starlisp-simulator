...
(defstruct (pvar-struct (:predicate #+(OR CMU CORMANLISP) %internal-pvarp #-(OR CMU CORMANLISP) internal-pvarp) 
...
(defun internal-pvarp (x) 
  (and (common-lisp::structurep x) (eq 'pvar-struct (common-lisp::struct-type x))))
